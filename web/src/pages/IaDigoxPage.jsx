    ...
    <div className="dashboard">
      ...
      <div className="hero">
        <div className="hero-top">
          ...
          <a
            href="https://github.com/mindset-code/ia-digox-services"
      ...
      <footer>
        <p>
          ...
          <a href="https://github.com/mindset-code/ia-digox-services" target="_blank" rel="noreferrer">
            ia-digox-services
          </a>
          {' '}&middot; Construido por{' '}
          <Link to="/">Mindset & Code</Link>
        </p>
      </footer>
    </div>
  )
