...
const T = {
  es: {
    ...
    stats: [
      ...
      { num: '10',   lbl: 'Proyectos portafolio' },
      { num: '100%', lbl: 'Trabajo remoto' },
      { num: 'MBA',  lbl: '+ Business Analytics' },
      { num: 'ISC2', lbl: 'CC Certified' },
    ],
    projectsTitle: 'Proyectos de portafolio',
    projectsDesc:  'Diez proyectos end-to-end publicados en GitHub: Data Engineering, BI, Data Science, Revenue Management, Web Development, Ciberseguridad y AI Automation. Siete con dashboard live interactivo.',
    viewBtn:     'Ver →',
  ...
  en: {
    ...
    stats: [
      ...
      { num: '10',   lbl: 'Portfolio projects' },
      { num: '100%', lbl: 'Remote work' },
      { num: 'MBA',  lbl: '+ Business Analytics' },
      { num: 'ISC2', lbl: 'CC Certified' },
    ],
    projectsTitle: 'Portfolio Projects',
    projectsDesc:  'Ten end-to-end projects published on GitHub: Data Engineering, BI, Data Science, Revenue Management, Web Development, Cybersecurity and AI Automation. Seven with a live interactive dashboard.',
    viewBtn:     'View →',
