...
export default function HomePage() {
  ...
  return (
    <div className="home-page">
      ...
      <footer>
        <p>
          <a href="https://linkedin.com/company/mindset-code" target="_blank" rel="noreferrer">linkedin.com/company/mindset-code</a>
          {' '}&middot;{' '}
          <a href="https://github.com/mindset-code" target="_blank" rel="noreferrer">github.com/mindset-code</a>
          {' '}&middot;{' '}
