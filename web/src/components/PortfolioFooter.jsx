...
export default function PortfolioFooter({ context }) {
  ...
  return (
    <footer>
      {context && <p className="footer-context">{context}</p>}
      <div className="footer-links">
        <a href="https://linkedin.com/in/guillermo-ubeda-garay" target="_blank" rel="noreferrer" className="footer-link">
          ...
          <span className="footer-link-text">linkedin.com/in/guillermo-ubeda-garay</span>
        </a>
        ...
        <a href="https://github.com/Guillermo1987" target="_blank" rel="noreferrer" className="footer-link">
          ...
          <span className="footer-link-text">github.com/Guillermo1987</span>
        </a>
        <span className="footer-sep">&middot;</span>
      ...
      <p className="footer-built">{BUILT[lang]} <a href="https://linkedin.com/in/guillermo-ubeda-garay" target="_blank" rel="noreferrer">Guillermo Ubeda Garay</a></p>
    </footer>
  )
}
